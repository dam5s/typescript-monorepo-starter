...
export type Value =
    ...
    | { reducer: 'joke', type: 'finished loading joke', result: Result.Value<JokeData, Http.HttpError> }
...
export const finishedLoading = (result: Result.Value<JokeData, Http.HttpError>): Value =>
